...
from tap_oracle_fusion.client import Client
from tap_oracle_fusion.exceptions import *
...
class TestClient(unittest.TestCase):
    ...
    @patch("tap_oracle_fusion.client.session")
    ...
    @patch("tap_oracle_fusion.client.Client._Client__make_request")
    ...
    @parameterized.expand([
        ["400 error", 400, MockResponse(400), OracleFusionBadRequestError, "A validation exception has occurred."],
        ["401 error", 401, MockResponse(401), OracleFusionUnauthorizedError, "The access token provided is expired, revoked, malformed or invalid for other reasons."],
        ["403 error", 403, MockResponse(403), OracleFusionForbiddenError, "You are missing the following required scopes: read"],
        ["404 error", 404, MockResponse(404), OracleFusionNotFoundError, "The resource you have specified cannot be found."],
        ["409 error", 409, MockResponse(409), OracleFusionConflictError, "The API request cannot be completed because the requested operation would conflict with an existing item."],
    ])
    ...
    @parameterized.expand([
        ["422 error", 422, MockResponse(422), OracleFusionUnprocessableEntityError, "The request content itself is not processable by the server."],
        ["429 error", 429, MockResponse(429), OracleFusionRateLimitError, "The API rate limit for your organisation/application pairing has been exceeded."],
        ["500 error", 500, MockResponse(500), OracleFusionInternalServerError, "The server encountered an unexpected condition which prevented it from fulfilling the request."],
        ["501 error", 501, MockResponse(501), OracleFusionNotImplementedError, "The server does not support the functionality required to fulfill the request."],
        ["502 error", 502, MockResponse(502), OracleFusionBadGatewayError, "Server received an invalid response."],
        ["503 error", 503, MockResponse(503), OracleFusionServiceUnavailableError, "API service is currently unavailable."],
    ])
    @patch("time.sleep")
